...
<html lang="en">
    ...
    <%! List<LocationDetails> locationList;
        ...
        LocationCategoryDetails categoryDetails;
         ...
         <%
                ...
                <div id="content">
                    <div id="menu" class="home">
                        ...
                        <ul id="root-menu" class="sf-menu">
                            <li><a href="user/viewuser.jsp"  >Display Profile</a></li>        
                ...
                <%
                    ...
                    categoryDetails = (LocationCategoryDetails) request.getAttribute("categoryDetails");


                %>
           
                <div id="content">
                    <h1 align ="middle">Select Locations From Category <%=categoryDetails.getLocationCategoryType()%></h1>
