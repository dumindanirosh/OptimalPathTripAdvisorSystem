...
<html lang="en">
    ...
    <%!            List<LocationCategoryDetails> listOfCategories;
        List<LocationDetails> locationDetail;
    ...
    <body>
        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="content" >
                    <div id="intro">
                        <h1><span> Select Location To View</span></h1>
                        ...
                        <div id="intro" align="center" style="border: #212121 dashed">                        
                            <form action="LocationControlServlet" method="POST">
                                <table border="1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><label for="firstname" style="font-size: 20px"> Location ID : </label></td>
                                            <td> 
                                                <select name="locationid" >

                                                    <%
                                                        locationDetail = (List<LocationDetails>) request.getAttribute("locationsList");

                                                        Iterator<LocationDetails> it1 = locationDetail.iterator();
                                                        while (it1.hasNext()) {
                                                            LocationDetails locationD = it1.next();
                                                    %>



                                                    <option value="<%= locationD.getLocationId().toString()%>">
                                                        <%= locationD.getLocationName()%>
                                                    </option>
                                                    <% }%>
                                                </select>    
                                ...
                                <div>
                                    ...
                                    <input type = "hidden" name = "action" value ="viewlocation">
