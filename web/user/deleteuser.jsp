                ...
                <div id="content">
                    <div id="intro">
                        <form action="/OptimalPathTripAdvisorSystem/UserControlServlet" method="POST">
                            ...
                            <br/>
                            <input type="submit" id="submit" class="medium gray button" value="Yes" />
                           <br/><br/>


                        </form>
                        <br/>   <a href="forwardAction?forwardPage=user/viewuser.jsp" style="font-size: 12pt;">Go Back To Profile Details</a>
