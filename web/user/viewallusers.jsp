                        ...
                        <div id="intro" align="center" style="border: #212121 dashed">                        
                                ...
                                <table border="1">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            userDetails = (List<UserDetails>) request.getAttribute("userList");

                                            for (UserDetails userD : userDetails) {
                                        %>
                                        <tr>
                                            <td><%=userD.getFirstName()%></td>
                                            <td>  <%=userD.getLastName()%> </td>
                                            <td> <%=userD.getEmailAddress()%></td>
