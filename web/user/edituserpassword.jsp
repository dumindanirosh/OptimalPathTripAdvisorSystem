                ...
                <div id="content" class="room-content">
                    <div id="intro">
                        <ul>  
                            ...
                            <li><a href="forwardAction?forwardPage=user/edituser.jsp?username=<%=user.getUsername()%>" class="large blue button ">Edit Profile</a>
                                ...
                                <a href="forwardAction?forwardPage=user/edituserpassword.jsp?username=<%=user.getUsername()%>" class="large blue button">Edit Password</a>
                    ...
                    <div class="container section" >
                        ...
                        <div id="intro" align="center" >     
                            ...
                            <h3>Update Password Details</h3>
                            <form action="/OptimalPathTripAdvisorSystem/UserControlServlet" method="POST">
                                <table border="1" style="border: #212121 dashed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><label style="font-size: 20px">New Password  :</label></td>
                                            <td><input type="password" name="newPassword"  /> </td>
                                        </tr>
                                        <tr>
                                            <td><label style="font-size: 20px">Confirm New Password :</label></td>
