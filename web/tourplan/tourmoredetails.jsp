...
<html lang="en">
    ...
    <%!        LocationDetails location;
        ...
        List<LocationDetails> locationsForTour;
                ...
                <div class="container section">
                    ...
                    <div id="intro">
                        ...
                        <%
                            ...
                            al = (List<LocationDetails>) session.getAttribute(BackendConstants.TOUR_LOCATIONS);
                            String tourplannerlistid = (String) session.getAttribute("tourplannerlistid");
                        %>
                        <table border="1">

                            <tbody>
                                <tr>
                                    <td><label style="font-size: 20px">Tour Planner List: </label></td>
                                    <td> <%=tourplannerlistid%></td>

                                </tr>
                                <%

                                    Iterator<LocationDetails> it1 = al.iterator();
                                    while (it1.hasNext()) {
                                        LocationDetails location = it1.next();
                        ...
                        <a href="TourPlanListControlServlet?action=viewalltours&tourplannerlistid=<%=tourplannerlistid%>" class="large gray button" >View All Tours</a>
