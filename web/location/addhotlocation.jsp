    ...
    <body>
        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <%
                    locationD = (List<LocationDetails>) request.getAttribute("locationList");

                    Iterator<LocationDetails> it1 = locationD.iterator();
                %>


                <div id="content" >
                    <div id="intro">
                        <h1><span> Add Hot Location</span></h1>
                    ...
                    <div class="container section" >
                        ...
                        <div id="intro" align="center" style="border: #212121 dashed">                        
                            <form action="/OptimalPathTripAdvisorSystem/LocationControlServlet" method="POST">
                                            ...
                                            <td> <select id="locationid" name="locationid" >
                                                    ...
                                                    <%
                                                        ...
                                                        while (it1.hasNext()) {
                                                            ...
                                                            LocationDetails locationDetail = it1.next();

                                                    %>
                                                    <option value="<%= locationDetail.getLocationId().toString()%>">
                                ...
                                <div>
                                    <br/>
                                    <input type = "hidden" name = "action" value ="addhotlocation">
