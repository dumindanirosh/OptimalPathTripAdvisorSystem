        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <%
                    ...
                    Integer locationCategoryId = (Integer) request.getAttribute("locationCategoryId");
                    String locationCategoryID = Integer.toString(locationCategoryId);
                ...
                <div id="content" >
                    <div id="intro">
                        <h1><span> Add Location Image</span></h1>
                    ...
                    <div class="container section" >
                        ...
                        <div id="intro" align="center" style="border: #212121 dashed">                        
                            ...
                            <form method="POST"  action="/OptimalPathTripAdvisorSystem/LocationImageControlServlet?action=addlocationimage&locationID=<%=locationID%>&locationCategoryID=<%=locationCategoryID%>"
                                  enctype="multipart/form-data">


                                Main Image Name :  <input type="file" name="dataFile"
                                                          id="fileChooser" /><br/>
                                ...
                                <input type="submit" id="submit" class="medium gray button" value="Upload" />
                            </form>
                        </div>
