        ...
        <div id="root-container" class="container">
         ...
         <%
                ...
                <div id="content" class="room-content">
                    <div id="intro">
                        <h1><span>Category Type : <%=categoryDetails1.getLocationCategoryType()%> <br/></span></h1>
                         <%
                                locationDetails = (List<LocationDetails>) request.getAttribute("locationByCategoryList");
